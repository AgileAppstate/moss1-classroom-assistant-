...
/******/ 	return __webpack_require__(__webpack_require__.s = "./app/main-process/main.js");
/******/ })
/************************************************************************/
/******/ ({
...
/*!**************************************!*\
  !*** ./app/main-process/letsMove.js ***!
  \**************************************/
/*! exports provided: moveToApplicationsFolder */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "moveToApplicationsFolder", function() { return moveToApplicationsFolder; });
...
const { app, dialog } = __webpack_require__(/*! electron */ "electron")
...
const moveToApplicationsFolder = () => {
  ...
  if (typeof (app.isInApplicationsFolder) === typeof (Function)) {
    if (!app.isInApplicationsFolder() && !electron_is_dev__WEBPACK_IMPORTED_MODULE_0___default.a && !userOptedOut()) {
...
/***/ "./app/main-process/logger.js":
/*!************************************!*\
  !*** ./app/main-process/logger.js ***!
  \************************************/
/*! exports provided: initLogger */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
const updater = __webpack_require__(/*! ./updater */ "./app/main-process/updater.js")
const { initLogger } = __webpack_require__(/*! ./logger */ "./app/main-process/logger.js")
const {
  authorizeUser,
...
if (__webpack_require__(/*! electron-squirrel-startup */ "./node_modules/electron-squirrel-startup/index.js")) app.exit()
...
/***/ "./app/main-process/menu.js":
/*!**********************************!*\
  !*** ./app/main-process/menu.js ***!
  \**********************************/
/*! exports provided: generateMenu */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "generateMenu", function() { return generateMenu; });
/* eslint-env node */
const { app, Menu } = __webpack_require__(/*! electron */ "electron")
...
const defaultTemplate = [
  ...
  },
  {
    ...
    submenu: [
      {
        label: "Learn More",
        click() { __webpack_require__(/*! electron */ "electron").shell.openExternal("https://github.com/education/classroom-assistant") }
      }
    ]
  }
]
  ...
  defaultTemplate.unshift({
    ...
    submenu: [
      ...
      },
      {
        ...
        accelerator:  false ? undefined : "Ctrl+Shift+I",
        click(item, focusedWindow) {
...
/*!************************************************!*\
  !*** ./app/main-process/userAuthentication.js ***!
  \************************************************/
/*! exports provided: authorizeUser, setAccessTokenFromCode, loadAccessToken, deleteAccessToken */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "authorizeUser", function() { return authorizeUser; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "setAccessTokenFromCode", function() { return setAccessTokenFromCode; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "loadAccessToken", function() { return loadAccessToken; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "deleteAccessToken", function() { return deleteAccessToken; });
/* harmony import */ var axios__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! axios */ "./node_modules/axios/index.js");
/* harmony import */ var axios__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(axios__WEBPACK_IMPORTED_MODULE_0__);
/* harmony import */ var keytar__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! keytar */ "./node_modules/keytar/lib/keytar.js");
/* harmony import */ var keytar__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(keytar__WEBPACK_IMPORTED_MODULE_1__);
...
function authorizeUser(mainWindowRef, protocolHandler) {
  openAuthWindow(mainWindowRef, protocolHandler)
}

async function setAccessTokenFromCode(code, mainWindow) {
  if (authWindow) {
    authWindow.destroy()
  }
  // TODO: Error handling
  try {
    ...
    await keytar__WEBPACK_IMPORTED_MODULE_1___default.a.setPassword("Classroom-Assistant", "x-access-token", token)
...
async function loadAccessToken() {
  global.accessToken = await keytar__WEBPACK_IMPORTED_MODULE_1___default.a.getPassword(
    "Classroom-Assistant",
    "x-access-token"
  )
}
...
async function deleteAccessToken() {
  ...
  await keytar__WEBPACK_IMPORTED_MODULE_1___default.a.deletePassword("Classroom-Assistant", "x-access-token")
}

function openAuthWindow(mainWindow, protocolHandler) {
  const height = 650

  authWindow = new electron__WEBPACK_IMPORTED_MODULE_2__["BrowserWindow"]({
    height: height,
    width: 400,
    show: false,
    parent: mainWindow,
    webPreferences: {
      session: electron__WEBPACK_IMPORTED_MODULE_2__["session"].fromPartition("auth:session"),
      nodeIntegration: false,
    },
  })

  const authURL = new URL(`${axios__WEBPACK_IMPORTED_MODULE_0___default.a.defaults.baseURL}/login/oauth/authorize`)
...
async function fetchAccessToken(code) {
  ...
  const response = await axios__WEBPACK_IMPORTED_MODULE_0___default.a.post(accessTokenURL, {
